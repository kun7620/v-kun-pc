    ...
    <div class="rightSide" :class="{'hideRightSide':!hideRightSide}" v-if="!isShowContent">
      <ul>
        <li v-for="item in articleList">
          <h2 class="title"><a href="javascript:void(0)" @click="showContent(item)">{{item.articleName}}</a></h2>
          <div class="middle">
          ...
          .then(r => {
            ...
            setTimeout(() => {
              ...
              for (let i = 0; i < pre.length; i++) {
                let codes = pre[i].getElementsByTagName('code')[0];
                // 获取换行数
                ...
                copy.onclick = function(){
                  let innerText = this.parentNode.getElementsByTagName('code')[0].innerText;
