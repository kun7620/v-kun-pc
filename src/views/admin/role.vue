        ...
        <el-dialog
            ...
            <el-form ref="coreRole" :model="coreRole" label-width="80px">
                ...
                <el-form-item label="菜单">
                    <el-tree :data="menuTree"  node-key="menuUuid" ref="menuTree" :props="defaultProps" show-checkbox :default-checked-keys="defaultChecked"></el-tree>
                </el-form-item>
                <el-form-item label="权限">
                    <el-table
                        ...
                        <el-table-column
                                ...
                                label="请求类型">
                            <template slot-scope="scope">
                                <el-button :type="tableMethodClassName(scope)" class="rightMethodButton" plain>{{scope.row.rightMethod}}</el-button>
                            </template>
                        </el-table-column>
                        <el-table-column
