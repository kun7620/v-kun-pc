    ...
    <d2-container id="userList">
        ...
        <el-table
            ...
            <el-table-column
                ...
                <template slot-scope="scope">
                  <el-popover
                    placement="top-start"
                    trigger="hover">
                    <img :src="scope.row.userHeadPortrait" v-if="scope.row.userHeadPortrait" alt="" style="width: 150px;height: 150px;border-radius: 100px">
                  <img slot="reference" :src="scope.row.userHeadPortrait" v-if="scope.row.userHeadPortrait" alt="" style="width: 50px;height: 50px;border-radius: 100px;cursor: pointer">
                  </el-popover>
                </template>
            </el-table-column>
            <el-table-column
            ...
            <el-table-column label="操作">
                <template slot-scope="scope">
                    <i class="iconfont iconedit iconButton" @click="handleEdit(scope.$index, scope.row)"></i>
